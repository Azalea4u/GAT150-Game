...
#define EVENT_SUBSCRIBE(id, listener, function) kiko::EventManager::Instance().Subscribe(id, this, std::bind(&function, this, std::placeholders::_1))
#define EVENT_SUBSCRIBE(id, listener)			kiko::EventManager::Instance().Unsubscribe(id, this)
#define EVENT_DISPATCH(id, data)				kiko::EventManager::Instance().DispatchEvent(id, this)
