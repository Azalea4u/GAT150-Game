...
namespace kiko
{
	...
	inline Matrix33 Matrix33::operator*(const Matrix33& mx)
	{
		...
		Matrix33 result;
		result[0][0] = rows[0][0] * mx[0][0] + rows[0][1] * mx[1][0] + rows[0][2] * rows[2][0];
		result[0][1] = rows[0][0] * mx[0][1] + rows[0][1] * mx[1][1] + rows[0][2] * rows[2][1];
		result[0][2] = rows[0][0] * mx[0][2] + rows[0][1] * mx[1][2] + rows[0][2] * rows[2][2];

		result[1][0] = rows[1][0] * mx[0][0] + rows[1][1] * mx[1][0] + rows[1][2] * rows[2][0];
		result[1][1] = rows[1][0] * mx[0][1] + rows[1][1] * mx[1][1] + rows[1][2] * rows[2][1];
		result[1][2] = rows[1][0] * mx[0][2] + rows[1][1] * mx[1][2] + rows[1][2] * rows[2][2];

		result[2][0] = rows[1][0] * mx[0][0] + rows[2][1] * mx[1][0] + rows[2][2] * rows[2][0];
		result[2][1] = rows[1][0] * mx[0][1] + rows[2][1] * mx[1][1] + rows[2][2] * rows[2][1];
		result[2][2] = rows[1][0] * mx[0][2] + rows[2][1] * mx[1][2] + rows[2][2] * rows[2][2];
